...
{
    public partial class SitecoreSearch : System.Web.UI.UserControl
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            try
            {
                if (SessionManager.Instance.CurrentIndex == null ||
                    SessionManager.Instance.SitecoreSearchResult == null)
                {
                ...
                {
                    SetSearchInfoValues(SessionManager.Instance.SitecoreSearchResult.TimeElapsed,
                                        SessionManager.Instance.SitecoreSearchResult.SearchResultCollection.Count);

                    SearchResultGrid.DataSource = SessionManager.Instance.SitecoreSearchResult.AsDataTable(SessionManager.Instance.CurrentIndex.Fields, ExcludeEmptyField.Checked);
                    SearchResultGrid.DataBind();
                }
