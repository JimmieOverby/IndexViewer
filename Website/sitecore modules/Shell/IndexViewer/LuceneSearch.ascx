<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LuceneSearch.ascx.cs" Inherits="IndexViewer.LuceneSearch" %>
<%@ Register TagPrefix="uc" TagName="LuceneQueryType" Src="~/sitecore modules/Shell/IndexViewer/LuceneQueryType.ascx" %>
...
<div style="margin: 10px;">
    ...
    <table cellpadding="2px" cellspacing="2px">
        ...
        <tr>
            ...
            <td>
                <uc:LuceneQueryType ID="LuceneQueryType1" runat="server" />
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <uc:LuceneQueryType ID="LuceneQueryType2" runat="server" />
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <uc:LuceneQueryType ID="LuceneQueryType3" runat="server" />
            </td>
            <td>
        ...
        <tr>
            <td>
                ...
                <asp:CheckBox ID="ExcludeEmptyField" runat="server" Checked="true" />
            </td>
